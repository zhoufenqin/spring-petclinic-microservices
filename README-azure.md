...
Azure Spring Cloud enables you to easily run Spring Boot based microservices applications on Azure.

This quickstart shows you how to deploy and monitor an existing Java Spring Cloud application to Azure. When you're finished, you can continue to manage the application via the Azure CLI or switch to using the Azure portal.
