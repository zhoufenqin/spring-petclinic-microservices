...
Parameters:
  ...
  -GitHubToken     GitHub personal access token (if not provided, will use COPILOT_MCP_GITHUB_TOKEN environment variable)
...
Requirements:
  ...
  - Token should be set in COPILOT_MCP_GITHUB_TOKEN environment variable or passed via -GitHubToken parameter
"@
}
...
function Get-GitHubToken {
    ...
    if ($env:COPILOT_MCP_GITHUB_TOKEN) {
        return $env:COPILOT_MCP_GITHUB_TOKEN
    }
    ...
    throw "GitHub token not found. Please set COPILOT_MCP_GITHUB_TOKEN environment variable or provide -GitHubToken parameter."
}
